<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="prueba_grid.aspx.vb" Inherits="Reg_Merca_WebApp.prueba_grid" %>
                            ...
                            <form id="form1" runat="server">
                                <div class="body">
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" class="table table-bordered table-striped table-hover"
                                            Width="100%">
                                            <Columns>
