                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="50" placeholder="Nombre" AutoComplete="off" ValidationGroup="Validacliente" runat="server" class="form-control" ID="txtnombre" onkeypress="txNombres(event);"  onkeydown="mayus(this);borrarespacios(this);"   onkeyup="mayus(this); borrarespacios(this);" onfocusout="mayus(this);quitarEspacios(this);"></asp:TextBox>
                                    </div>
                      ...
                      <!--      <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="50" placeholder="Dirección domicilio" AutoComplete="off" ValidationGroup="Validaproveedores" runat="server" class="form-control" ID="txtdirecciondomicilio" onkeydown="mayus(this);borrarespacios(this);"   onkeyup="mayus(this); borrarespacios(this);" onfocusout="mayus(this);quitarEspacios(this);"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="50" placeholder="Dirección envío" AutoComplete="off" ValidationGroup="Validaproveedores" runat="server" class="form-control" ID="txtdireccionenvio" onkeydown="mayus(this);borrarespacios(this);"   onkeyup="mayus(this); borrarespacios(this);" onfocusout="mayus(this);quitarEspacios(this);"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="25" placeholder="Ciudad" AutoComplete="off" ValidationGroup="Validaproveedores" runat="server" class="form-control" ID="txtciudad" onkeydown="mayus(this);borrarespacios(this);" onkeyup="mayus(this); borrarespacios(this);" onfocusout="mayus(this);quitarEspacios(this);"></asp:TextBox>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="11" placeholder="Teléfono" AutoComplete="off" ValidationGroup="Validaproveedores" runat="server" class="form-control" ID="txttelefono" onkeypress="SoloNumeros();"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="11" placeholder="Teléfono2" AutoComplete="off" ValidationGroup="Validaproveedores" runat="server" class="form-control" ID="txttelefono2" onkeypress="SoloNumeros();"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox placeholder="Teléfono3" AutoComplete="off" ValidationGroup="Validaproveedores" runat="server" class="form-control" ID="txttelefono3" onkeypress="SoloNumeros();" MaxLength="11"></asp:TextBox>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox placeholder="fax" AutoComplete="off" ValidationGroup="Validaproveedores" runat="server" class="form-control" ID="txtfax" onkeypress="SoloNumeros();" MaxLength="11"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="25" placeholder="Contacto" AutoComplete="off" ValidationGroup="Validaproveedores" runat="server" class="form-control" ID="txtcontacto" onkeypress="return txtcontacto(event)"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="11" placeholder="Limite de credito" AutoComplete="off" ValidationGroup="Validaproveedor" runat="server" class="form-control" ID="txtlimitecr" onkeypress="SoloNumeros();"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="11" placeholder="Plazo de Credito" AutoComplete="off" ValidationGroup="Validaproveedor" runat="server" class="form-control" ID="txtplazocr" onkeypress="SoloNumeros();"></asp:TextBox>
                                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="50" placeholder="Nombre" AutoComplete="off" ValidationGroup="ValidaproveedorEditar" runat="server" class="form-control" ID="txtnombreEditar" onkeypress="txNombres(event);"  onkeydown="mayus(this);borrarespacios(this);"   onkeyup="mayus(this); borrarespacios(this);" onfocusout="mayus(this);quitarEspacios(this);"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="50" placeholder="Dirección domicilio" AutoComplete="off" ValidationGroup="ValidaproveedorEditar" runat="server" class="form-control" ID="txtdirecciondomicilioEditar" onkeydown="mayus(this);borrarespacios(this);"   onkeyup="mayus(this); borrarespacios(this);" onfocusout="mayus(this);quitarEspacios(this);"></asp:TextBox>
                                    </div>
                             ...
                             <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="50" placeholder="Dirección envio" AutoComplete="off" ValidationGroup="ValidaproveedorEditar" runat="server" class="form-control" ID="txtdireccionenvioEditar" onkeydown="mayus(this);borrarespacios(this);"   onkeyup="mayus(this); borrarespacios(this);" onfocusout="mayus(this);quitarEspacios(this);"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="25" placeholder="Ciudad" AutoComplete="off" ValidationGroup="ValidaproveedorEditar" runat="server" class="form-control" ID="txtciudadEditar" onkeydown="mayus(this);borrarespacios(this);"   onkeyup="mayus(this); borrarespacios(this);" onfocusout="mayus(this);quitarEspacios(this);"></asp:TextBox>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="11" placeholder="Teléfono" AutoComplete="off" ValidationGroup="ValidaproveedoresEditar" runat="server" class="form-control" ID="txttelefonoEditar" onkeypress="SoloNumeros();"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="11" placeholder="Teléfono2" AutoComplete="off" ValidationGroup="ValidaproveedoresEditar" runat="server" class="form-control" ID="txttelefono2Editar" onkeypress="SoloNumeros();"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="11" placeholder="Teléfono3" AutoComplete="off" ValidationGroup="ValidaproveedoresEditar" runat="server" class="form-control" ID="txttelefono3Editar" onkeypress="SoloNumeros();"></asp:TextBox>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="11" placeholder="fax" AutoComplete="off" ValidationGroup="ValidaproveedoresEditar" runat="server" class="form-control" ID="txtfaxEditar" onkeypress="SoloNumeros();"></asp:TextBox>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="25" placeholder="Contacto" AutoComplete="off" ValidationGroup="ValidaproveedoresEditar" runat="server" class="form-control" ID="txtcontactoEditar" onkeypress="return txtcontacto(event);"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="25" placeholder="Limite de credito" AutoComplete="off" ValidationGroup="ValidaproveedoresEditar" runat="server" class="form-control" ID="txtlimitecrEditar" onkeypress="SoloNumeros();"></asp:TextBox>
                                    </div>
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <asp:TextBox MaxLength="25" placeholder="Plazo de credito" AutoComplete="off" ValidationGroup="ValidaproveedoresEditar" runat="server" class="form-control" ID="txtplazocrEditar" onkeypress="SoloNumeros();"></asp:TextBox>
                                    </div>
