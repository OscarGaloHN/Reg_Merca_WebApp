  ...
  <script src="https://cdn.datatables.net/buttons/1.7.0/js/buttons.html5.min.js "></script>
    ...
    <script type="text/javascript">
        ...
        function GetSelectedRowDelete(lnk) {
            ...
            document.getElementById('ContentPrincipal_lblunidad').innerHTML = row.cells[2].innerHTML + ' - ' + row.cells[3].innerHTML;
            document.getElementById('ContentPrincipal_lblHiddenIDunidad').value = row.cells[2].innerHTML;
            document.getElementById('ContentPrincipal_lblHiddenNombreunidad').value = row.cells[3].innerHTML;
            xModal('red', 'ContentPrincipal_txtunidad', 'modalDelete');
        }
        ...
        function GetSelectedRowEdit(lnk) {
            ...
            document.getElementById('ContentPrincipal_lblHiddenNombre').value = row.cells[3].innerHTML;
