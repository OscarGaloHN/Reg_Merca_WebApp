            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <asp:TextBox ID="txt_motivoperacion" AutoComplete="off" runat="server" onkeyup="mayus(this)" class="form-control" onkeypress="return isNumberOrLetter(event)"></asp:TextBox>
