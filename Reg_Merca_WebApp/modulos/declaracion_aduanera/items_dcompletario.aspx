<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/modulos/declaracion_aduanera/master_registros.master" CodeBehind="items_dcompletario.aspx.vb" Inherits="Reg_Merca_WebApp.items_dcompletario" %>
    ...
    <script type="text/javascript">
        ...
        function GetSelectedRowEdit(lnk) {
            ...
            if (row.cells[3].innerHTML != '&nbsp;') {
                document.getElementById('ContentPrincipal_ddlcomplementariedit').value = row.cells[3].innerHTML;
            }
