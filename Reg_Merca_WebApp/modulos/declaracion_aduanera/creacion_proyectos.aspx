<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/modulos/declaracion_aduanera/master_registros.master" CodeBehind="creacion_proyectos.aspx.vb" Inherits="Reg_Merca_WebApp.creacion_proyectos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetSelectedRow(lnk) {
            ...
            //desición no permite eliminar el ADMIN
...
<asp:Content ID="Content2" ContentPlaceHolderID="encabezado" runat="server">
    <a class="navbar-brand" href="#">Creación de proyectos</a>
</asp:Content>
        ...
        <li class="active">
            <a href="#">
               <i class="material-icons">manage_accounts</i>
                <span>Creación de proyectos</span>
            </a>
        </li>
    </ul>
</asp:Content>
                        ...
                        <div class="modal-content">
                            ...
                            <asp:Panel ID="PanelEditor" runat="server" DefaultButton="bttEliminar">
                                ...
                                <div class="modal-body"> 
                                    ...
                                    <br /> <b>El usuario pertenece a:</b>  <asp:Label ID="lblUsuario" class="msg" runat="server" Text="..."></asp:Label> <br /> Si desea eliminar este registro de usuario, haga clic en el botón eliminar para continuar <br> De lo contrario clic en cerrar para cancelar.
                                    <br />
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
