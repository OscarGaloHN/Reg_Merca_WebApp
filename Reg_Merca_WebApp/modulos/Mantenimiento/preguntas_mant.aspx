    ...
    <script type="text/javascript">
        ...
        function GetSelectedRowEdit(lnk) {
            ...
            if (row.cells[2].innerHTML != '&nbsp;') {
                document.getElementById('ContentPrincipal_txtpreguntaEditar').value = row.cells[2].innerHTML;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="encabezado" runat="server">
    <a class="navbar-brand" href="#">Matenimiento de Preguntas</a>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPrincipal" runat="server">
    <script type="text/javascript">
        tituloImprimir = 'Listado de Preguntas'
                ...
                <div class="body">
                    <div class="row clearfix">
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 ">
                            <button onclick="borrarTxtNuevo(); xModal('teal','ContentPrincipal_txtpregunta','modalNuevo');" type="button" class="btn btn-block btn-lg bg-teal waves-effect">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="table-responsive">
                                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" class="table table-bordered table-striped table-hover display compact"
                                    Width="100%">
                                    <Columns>
                                        <asp:BoundField HeaderText="Editar" DataField="id_pregunta" HtmlEncode="False" DataFormatString="<a class='btn bg-pink waves-effect' href='config_gestion_usuario.aspx?xuser={0}&action=update&ignore=92'><i class='material-icons'>edit</i> </a>" />
